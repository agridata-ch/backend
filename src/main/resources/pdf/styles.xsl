...
>
    ...
    <xsl:attribute-set name="font-liberation-sans-11" use-attribute-sets="font-liberation-sans">
        <xsl:attribute name="font-size">11pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="font-liberation-sans-12" use-attribute-sets="font-liberation-sans">
        <xsl:attribute name="font-size">12pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="font-liberation-sans-14" use-attribute-sets="font-liberation-sans">
        <xsl:attribute name="font-size">14pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="document-title" use-attribute-sets="font-liberation-sans-14">
